...
public class Theatre6 implements backToFirstPage{
    ...
    private MyFile fileBookingTheatre6  ;

    @FXML  public void initialize() {// method เริ่มต้น เมื่อย้ายมา scene นี้ จะทำการสร้างเก้าอี้ (Object) แล้วเก็บใน ArrayList
        String fs = File.separator;
        fileBookingTheatre6 = new MyFile(System.getProperty("user.dir") + fs + "bookingchair" + fs + "chairselectedtheatre6", "chairbookingtheatre6.txt");
    ...
    public void readFile(){
        try {
            File file = new File(fileBookingTheatre6.getDirectory());
            if (!file.exists()) file.mkdirs();
            FileReader fileReader = new FileReader(fileBookingTheatre6.getFilename());
            ...
            System.err.println("Cannot read file "+fileBookingTheatre6.getFilename());
        }
        catch (IOException e){
    ...
    public void writeFileAfterCancelBooking(){
        ...
        try {
            fileWriter = new FileWriter(fileBookingTheatre6.getFilename());
